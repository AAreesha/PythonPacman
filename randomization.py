        ...
        if self.direction == 0: #right
            if self.target[0] > self.x_pos and self.turns[0]:
                ...
                while self.direction == 0:
                    ...
                    if t == 3 and self.turns[3]:
                        self.direction = 3
                        self.y_pos += self.speed
                    elif t == 2 and self.turns[2]:
                        self.direction = 2
                        self.y_pos -= self.speed
                    elif t == 1 and self.turns[1]:
                        self.direction = 1
                        self.x_pos -= self.speed
            elif self.turns[0]:
                self.x_pos += self.speed
            ...
            if self.target[1] > self.y_pos and self.turns[3]:
                ...
                while self.direction == 3:
                    t = random.choice([1,2,0])
                    if t == 0 and self.turns[0]:
                        self.direction = 0
                        self.x_pos += self.speed
                    elif t == 2 and self.turns[2]:
                        self.direction = 2
